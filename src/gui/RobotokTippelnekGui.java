...
public class RobotokTippelnekGui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        chkKulonbozoSzamok = new javax.swing.JCheckBox();
        ...
        chkKulonbozoSzamok.setSelected(true);
        chkKulonbozoSzamok.setText("Különböző számok");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(chkKulonbozoSzamok)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
...
//        Object ertek = jSpinner1.getValue();
//        System.out.println("Minimum: " + ertek);

        int min = (int) numMin.getValue();
        int max = (int) numMax.getValue();
        
        boolean kulonbozoSzamok = chkKulonbozoSzamok.isSelected();
        int veletlenSzam1;
        int veletlenSzam2;
        
        int db = max - min + 1;
        veletlenSzam1 = (int)(Math.random() * db) + min;
        txtVelSzam1.setText(veletlenSzam1 + "");
        txtVelSzam2.setText(veletlenSzam1 + "");
        
        veletlenSzam2 = (int)(Math.random() * db) + min;
        if (kulonbozoSzamok == true) {
            txtVelSzam1.setText(veletlenSzam1 + "");
    ...
    private void kilepes() {
        ...
        String uzenet = "Biztos kilép?";
        int gombok = JOptionPane.OK_CANCEL_OPTION;
        int valasz = JOptionPane.showConfirmDialo(rootPane, uzenet, cim, gombok);
        if (valasz == JOptionPane.OK_OPTION) {
            final int HIBA_KOD = 0;
            System.exit(HIBA_KOD);
        }
    ...
    private javax.swing.JCheckBox chkKulonbozoSzamok;
